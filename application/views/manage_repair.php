                    ...
                    <table id="mytable" class="table table-bordred table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url();?>evis_shop/print_repair/<?php echo $v_repair->repair_id;?>" class="btn btn-info" data-toggle="tooltip" title="Print Repair"><i class="fa fa-gear"></i></a>
