                    ...
                    <table id="mytable" class="table table-bordred table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url();?>evis_shop/print_sales/<?php echo $v_sales->sales_id;?>" class="btn btn-info" data-toggle="tooltip" title="Print Sales"><i class="fa fa-gear"></i></a>
